...
const LeadershipContent = () => {
  return (
    <div className="p-4 md:p-8">
      ...
      <p className="text-gray-600 text-sm md:text-base text-center max-w-3xl mx-auto mb-8 md:mb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-gray-600 text-xs md:text-sm">
            ...
            growth at GENTEC. His expertise in financial planning, cost
        ...
        <div className="flex flex-col">
          ...
          <p className="text-gray-600 text-xs md:text-sm">
            ...
            he plays a pivotal role in enhancing GENTEC's operational efficiency
