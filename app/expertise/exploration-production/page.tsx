          ...
          <div className="container mx-auto px-4 h-full flex flex-col justify-end pt-20 pb-16 sm:pt-24 sm:pb-20 md:pt-48 md:pb-24">
            ...
            <div className="max-w-3xl space-y-4 sm:space-y-6">
              ...
              <p className="text-white/90 text-sm sm:text-base md:text-xl max-w-2xl leading-relaxed">
                As an indigenous company with significant upstream capabilities,
                we enhance exploration and production performance through
                strategic field development, technical innovation, and strict
                adherence to international safety standards — helping partners
                optimize hydrocarbon recovery and unlock asset value in
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                A full-cycle energy company focused on the exploration,
                development, and production of hydrocarbons, contributing to
                Nigeria's energy security and resource optimization.
              </p>
        ...
        <div id="ppl229" className="scroll-mt-24 mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Awarded in 2022, PPL 229 covers 61.33 sq. km in shallow offshore
                waters with a depth of approximately 72 feet. The block includes
                the Ede Field — a confirmed oil and gas field — along with
                several other discovered but undeveloped hydrocarbon prospects.
              </p>
